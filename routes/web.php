...
Route::resource('brand/brand', 'Brand\\BrandController');
Route::resource('banner/banner', 'Banner\\BannerController');
Route::resource('product/product', 'Product\\ProductController');
Route::resource('coupon/coupon', 'Coupon\\CouponController');
Route::resource('stockmanagement/stock-management', 'StockManagement\\StockManagementController');