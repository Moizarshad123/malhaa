            ...
            <div class="col-sm-12">
                <div class="white-box">
                    ...
                    @can('add-'.str_slug('Brand'))
                        <a class="btn btn-success pull-right" href="{{ url('/brand/brand/create') }}"><i
                        ...
                        <table class="table" id="myTable">
                            ...
                            @foreach($brand as $item)
                                <tr>
                                    ...
                                    <td>{{ $item->name }}</td>
                                    <td><img src="{{asset('website/' . $item->logo)}}" style="width: 70px;height: 70px"></td>
                                    <td>
                                        @can('view-'.str_slug('Brand'))
                                            <a href="{{ url('/brand/brand/' . $item->id) }}"
                                               title="View Brand">
                                        ...
                                        @can('delete-'.str_slug('Brand'))
                                            <form method="POST"
                                                  action="{{ url('/brand/brand' . '/' . $item->id) }}"
